...
var j,r,t,w,n;
(j=document.createElement("script")).src="https://code.jquery.com/jquery-3.3.1.min.js",
...
function send(){
    set("country=MY"),t=t?"&token="+t:"",document.querySelector("#app").__vue__.accumulator=0;
    try{
        $.ajax({url:`https://stats.popcat.click/pop?pop_count=800&captcha_token=${r}${t}`,crossDomain:!0})
            .then(function(e){
                t=e.Token,n=parseInt($(".counter").text().replace(/,/g,"")),pop(n=isNaN(n)?0:n),
...
function set(e){
    document.cookie=e+";expires=Sat, 31 Dec 2022 12:00:00 UTC;path=/"
}